...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMyServer_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(45, 4) // "port"
    ...
    "QMyServer\0recvVideo\0\0serverInit\0"
    "serverListen\0port"
};
...
void QMyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyServer::recvVideo)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QMyServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMyServer.offsetsAndSize,

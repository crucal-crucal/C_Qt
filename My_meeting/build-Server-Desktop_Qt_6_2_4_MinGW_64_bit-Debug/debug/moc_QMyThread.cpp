...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMyThread_t, stringdata0) + ofs), len 
...
void QMyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyThread::recvVideo)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QMyThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMyThread.offsetsAndSize,

...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMyCamera_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(76, 11) // "catchCamera"
    ...
    "QMyCamera\0currentPictrueChanged\0\0"
    "startCamera\0stopCamera\0getImage\0id\0"
    "preview\0catchCamera"
};
...
void QMyCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCamera::currentPictrueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QMyCamera::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMyCamera.offsetsAndSize,

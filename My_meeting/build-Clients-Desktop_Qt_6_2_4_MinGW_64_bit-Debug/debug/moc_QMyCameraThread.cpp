...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMyCameraThread_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(131, 10) // "stopCamera"
    ...
    "QMyCameraThread\0forwardCameraPic\0\0"
    "forward_shareDesktopPic\0"
    "forward_sendServerDeskPic\0stopShareDesktop\0"
    "startShareDesktop\0startCamera\0stopCamera"
};
...
void QMyCameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::forwardCameraPic)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::forward_shareDesktopPic)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::forward_sendServerDeskPic)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::stopShareDesktop)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QMyCameraThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::startShareDesktop)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (QMyCameraThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::startCamera)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QMyCameraThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyCameraThread::stopCamera)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QMyCameraThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMyCameraThread.offsetsAndSize,

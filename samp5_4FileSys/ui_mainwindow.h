...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actbackroot = new QAction(MainWindow);
        actbackroot->setObjectName(QString::fromUtf8("actRootback"));
        actbackroot->setText("返回根目录");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/icons/324.bmp"), QSize(), QIcon::Normal, QIcon::Off);
        actbackroot->setIcon(icon3);

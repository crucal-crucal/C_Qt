...
#include <memory>
#include "../../../QMediaPlayer(listview/mynetwork.h"
...
static const qt_meta_stringdata_MyNetWork_t qt_meta_stringdata_MyNetWork = {
    {
        ...
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 11),  // "QList<QUrl>"
        QT_MOC_LITERAL(38, 8),  // "DataBack"
...
void MyNetWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->SearchFinished((*reinterpret_cast< std::add_pointer_t<QList<QUrl>>>(_a[1]))); break;
        ...
        {
            using _t = void (MyNetWork::*)(QVector<QUrl> );
...
, QtPrivate::TypeAndForceComplete<MyNetWork, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QVector<QUrl>, std::false_type>
...
// SIGNAL 0
void MyNetWork::SearchFinished(QVector<QUrl> _t1)
{

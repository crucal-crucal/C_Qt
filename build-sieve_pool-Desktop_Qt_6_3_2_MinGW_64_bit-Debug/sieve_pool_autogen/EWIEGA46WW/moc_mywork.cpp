...
#include <memory>
<<<<<<<< HEAD:My_meeting/build-Clients-Desktop_Qt_6_2_4_MinGW_64_bit-Debug/debug/moc_QMyThreadPool.cpp
#include "../../Clients/QMyThreadPool.h"
========
#include "../../../sieve_pool/mywork.h"
>>>>>>>> 47b8f66 (update):build-sieve_pool-Desktop_Qt_6_3_2_MinGW_64_bit-Debug/sieve_pool_autogen/EWIEGA46WW/moc_mywork.cpp
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_work1_t, stringdata0) + ofs), len 
...
void work1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&work1::exampleSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject work1::staticMetaObject = { {
    ...
    qt_meta_stringdata_work1.offsetsAndSize,
    qt_meta_data_work1,
    qt_static_metacall,
    nullptr,

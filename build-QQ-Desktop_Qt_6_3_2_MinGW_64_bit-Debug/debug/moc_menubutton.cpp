...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MenuButton_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_MenuButton_t qt_meta_stringdata_MenuButton = {
    {
        QT_MOC_LITERAL(0, 10),  // "MenuButton"
        QT_MOC_LITERAL(11, 8),  // "PushMenu"
        QT_MOC_LITERAL(20, 0)   // ""
    },
    "MenuButton",
    "PushMenu",
...
const QMetaObject MenuButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_MenuButton.offsetsAndSizes,
    qt_meta_data_MenuButton,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MenuButton_t
, QtPrivate::TypeAndForceComplete<MenuButton, std::true_type>

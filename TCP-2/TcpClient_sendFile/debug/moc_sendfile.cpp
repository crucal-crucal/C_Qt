...
static const qt_meta_stringdata_SendFile_t qt_meta_stringdata_SendFile = {
    {
        ...
        QT_MOC_LITERAL(45, 10),  // "connectSuc"
        QT_MOC_LITERAL(56, 8)   // "dealRead"
    },
    "SendFile",
    "sigFileInfo",
    "",
...
static const uint qt_meta_data_SendFile[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       4,    0,   54,    2, 0x06,    7 /* Public */,
       5,    0,   55,    2, 0x06,    8 /* Public */,
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &SendFile::dealDisconnect; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        ...
        {
            using _t = void (SendFile::*)();
            if (_t _q_method = &SendFile::dealRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }

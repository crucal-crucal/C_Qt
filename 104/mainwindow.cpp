...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    //    connect(this, &MainWindow::modify_in_xml_server, modify_xml.get(), &modifyXml::modifyServer,
    //    Qt::UniqueConnection); connect(this, &MainWindow::modify_in_xml_server_telemetry, modify_xml.get(),
    //    &modifyXml::modifyServer_Telemetry,
    //            Qt::UniqueConnection);
    //    connect(this, &MainWindow::modify_in_xml_server_telesigna, modify_xml.get(),
    //    &modifyXml::modifyServer_Telesigna,
    //            Qt::UniqueConnection);
    //    connect(this, &MainWindow::modify_in_xml_client, modify_xml.get(), &modifyXml::modifyClient,
    //    Qt::UniqueConnection); connect(this, &MainWindow::modify_in_xml_client_telemetry, modify_xml.get(),
    //    &modifyXml::modifyClient_Telemetry,
    //            Qt::UniqueConnection);
    //    connect(this, &MainWindow::modify_in_xml_client_telesigna, modify_xml.get(),
    //    &modifyXml::modifyClient_Telesigna,
    //            Qt::UniqueConnection);
...
void MainWindow::TreeMenu_Server(const QPoint& pos) {
    ...
    if (idx.isValid()) {
        ...
        menu.addAction("addson", this, [=]() { serverForm_add_son(); });
    } else {
...
void MainWindow::TreeMenu_Client(const QPoint& pos) {
    ...
    if (idx.isValid()) {
        ...
        menu.addSeparator();  // 分割线
        menu.addAction("add son", this, [=]() { clientForm_add_son(); });
    }
    menu.exec(QCursor::pos());
}

...
#include <memory>
#include "../../TcpClient_sendFile/sendfile.h"
...
static const qt_meta_stringdata_SendFile_t qt_meta_stringdata_SendFile = {
    {
        ...
        QT_MOC_LITERAL(9, 10),  // "connectSuc"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 10),  // "disConnect"
        QT_MOC_LITERAL(32, 10)   // "curPercent"
    },
    "SendFile",
    "connectSuc",
    "",
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->curPercent((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SendFile::connectSuc; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SendFile::*)();
            if (_t _q_method = &SendFile::disConnect; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &SendFile::curPercent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<SendFile, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>

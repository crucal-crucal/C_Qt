...
void FramelessDialog::doResizeEvent(QEvent* event) { // NOLINT
...
void FramelessDialog::setPadding(const int _padding) {
	this->padding = _padding;
}

void FramelessDialog::setMoveEnable(const bool _moveEnable) {
	this->moveEnable = _moveEnable;
}

void FramelessDialog::setResizeEnable(const bool _resizeEnable) {

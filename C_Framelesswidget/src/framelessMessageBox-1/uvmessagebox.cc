...
CUVMessageBox::CUVMessageBox(const QMessageBox::Icon icon, const QString& title, const QString& text, const QMessageBox::StandardButtons buttons,
                             QWidget* parent, const Qt::WindowFlags flags)
: CUVBaseDialog(parent), m_pMessageBox(new QMessageBox(icon, "", text, buttons, this, flags)) {
	setTitle(title);
	...
	[[maybe_unused]] int nMinWidth = fontMetrics.horizontalAdvance(title);
...
QMessageBox::ButtonRole CUVMessageBox::information(QWidget* parent, const QString& title, const QString& text,
                                                   const QMessageBox::StandardButtons buttons, QMessageBox::StandardButton defaultButton) {
...
int CUVMessageBox::exec() {
	[[maybe_unused]] int nRet = CUVBaseDialog::exec();
...
void CUVMessageBox::onMsgBoxButtonClicked([[maybe_unused]] QAbstractButton* button) {
	close();
}
